  ...
  return {
    ...
    compile: function(elm, attrs, transclude) {
      return function postLink(scope, elm, attrs, tabsetCtrl) {
        ...
        //添加了一个关闭事件
        elm.find("button").bind('click', function (event) {
          scope.onClose();
        });
...
angular.module("template/datepicker/datepicker.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/datepicker.html",
    ...
    "      <th><a class=\"btn pull-left\" ng-click=\"move(-1)\"><i class=\"glyphicon glyphicon-chevron-left\"></i></button></th>\n" +
    "      <th colspan=\"{{rows[0].length - 2 + showWeekNumbers}}\"><button class=\"btn btn-info\" ng-click=\"toggleMode()\"><strong>{{title}}</strong></button></th>\n" +
    "      <th><a class=\"btn pull-right\" ng-click=\"move(1)\"><i class=\"glyphicon glyphicon-chevron-right\"></i></button></th>\n" +
    "    </tr>\n" +
...
angular.module("template/datepicker/popup.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/popup.html",
    ...
    "			<button class=\"btn btn-sm btn-primary\" ng-click=\"today()\">今天</button>\n" +
    "			<button class=\"btn btn-sm btn-info\" ng-click=\"showWeeks = ! showWeeks\" ng-class=\"{active: showWeeks}\">星期</button>\n" +
    "			<button class=\"btn btn-sm btn-danger\" ng-click=\"clear()\">清除</button>\n" +
    "		</span>\n" +
    "		<button class=\"btn btn-sm btn-success pull-right\" ng-click=\"isOpen = false\">关闭</button>\n" +
    "	</li>\n" +
    "</ul>");
}]);
...
angular.module("template/pagination/pager.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/pagination/pager.html",
    "  <ul class=\"pager\"> \n" +
    "    <li ng-repeat=\"page in pages\" ng-class=\"{disabled: page.disabled, previous: page.previous, next: page.next}\"><a class=\"btn\" ng-click=\"selectPage(page.number)\">{{page.text}}</a></li>\n" +
    "  </ul>\n" +
    "");
}]);
...
angular.module("template/pagination/pagination.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/pagination/pagination.html",
    "<ul class=\"pagination\">\n" +
    "  <li ng-repeat=\"page in pages\" ng-class=\"{active: page.active, disabled: page.disabled}\"><a class=\"btn\" ng-click=\"selectPage(page.number)\">{{page.text}}</a></li>\n" +
    "</ul>\n" +
    "");
}]);
...
//modified by jinlei 2013-11-1
angular.module("template/tabs/tab.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/tabs/tab.html",
    "<li ng-class=\"{active: active, disabled: disabled}\">\n" +
    "  <button type=\"button\" ng-click=\"close()\" class=\"close\" style=\"position:absolute;top:-2px;right:4px;z-index:100\" aria-hidden=\"true\">&times;</button>" +
